...
class ClienteBancario:
    ...
    def imprimirInfo(self) -> str:
            return "Nombre" + self.getNombreCompleto() + ", Edad" + str(self.__edad) + ", Balane: " +str(self.__balanceDeCuenta)
    ...
    def retirarDinero(self, cantidad:float) -> None:
        ...
        self.__mandarEmail("----- retirando dinero -----", " se retiraron" +str(cantidad))
        self.__enviarBalanceAlBanco(cantidad)
