...
class Persona:
    ...
    def imprimirInfo(self) -> None:
        print(f"--- Mi nomre es {self.nombres} {self.apellidos}, tengo {self.edad} años de edad, vivo en {self.direccion}")
...
#======================================
def funcion1():
    persona = Persona("Carlos","Pérez",40,"Xocjimilco","Lenovo",700,8)
    print("\n")
